...
def compare_answers(predicted_answer: str | None, ground_truth: str):
...
"""
    ...
    for event in reversed(state.history):
        if hasattr(event, 'role') and event.role == 'assistant':
            if hasattr(event, 'thought'):
                ...
                extracted_answer = parse_final_answer(event.thought)
                if extracted_answer:
            ...
            if hasattr(event, 'content'):
                ...
                extracted_answer = parse_final_answer(event.content)
                if extracted_answer:
    ...
    test_result = compare_answers(final_answer, instance['Answer'])
